...
test "storage: missing required frontmatter fields rejected" {
    ...
    const no_title =
        ...
        \\---
    ;
    try ts.storage.dots_dir.writeFile(.{ .sub_path = "no-title.html", .data = no_title });
    ...
    const no_created =
        ...
        \\---
    ;
    try ts.storage.dots_dir.writeFile(.{ .sub_path = "no-created.html", .data = no_created });
...
test "storage: invalid block id rejected" {
    ...
    const bad_blocks =
        ...
        \\---
    ;
    try ts.storage.dots_dir.writeFile(.{ .sub_path = "bad-blocks.html", .data = bad_blocks });
